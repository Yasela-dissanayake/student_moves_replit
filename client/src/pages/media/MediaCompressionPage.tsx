...
import { FileImage, FileVideo, HelpCircle, Home } from 'lucide-react';
import { useToast } from '@/hooks/use-toast';
import DashboardLayout from '@/components/layout/DashboardLayout';

export default function MediaCompressionPage() {
  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto py-8">
        <Helmet>
          <title>Media Compression Tool | UniRent Dashboard</title>
        </Helmet>
        ...
        <div className="mb-8">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/dashboard/media/compression">Media Compression</BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
