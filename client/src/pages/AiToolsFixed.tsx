                ...
                <div className="space-y-4">
                  <div>
                    <p className="mb-4 text-sm text-gray-600">
                      Enter your OpenAI API key to use advanced AI features. Your key is stored securely in your browser and not shared with any third parties.
                    </p>
                  ...
                  <Alert className="bg-blue-50 text-blue-700 border-blue-200">
                    ...
                    <AlertDescription>
                      Visit <a href="https://platform.openai.com/api-keys" className="underline" target="_blank" rel="noopener noreferrer">OpenAI API Keys</a> to create an account and generate an API key.
                    </AlertDescription>
                  </Alert>
                </div>
              </CardContent>
